...
function test(){
	...
	if(prob<25){
		...
		if(prob2===8) prob_calor();
		if(prob2===9) prob_rx_quim_calor_1();
		if(prob2===10) prob_rx_quim_calor_2();        
	}else{
        let prob2 = rndi(1,3);
        if(prob2===1) prob_calor_cambio_de_fase();
        if(prob2===2) prob_ec_clapeyron_fusion();
        if(prob2===3) prob_ec_clapeyron_simplificada_fusion();
	}
   
   

	//pruebame...
   //prob_ec_clapeyron_fusion();
   //prob_ec_clapeyron_simplificada_fusion();
