...
function test(){
    ...
    if( rndi(1,100) <= 95 ){
        ...
        if(prob===1) prob_Cp_Cv();
        if(prob===2) prob_calor_isobarico();
        if(prob===3) prob_calor_isocorico();
        if(prob===4) prob_trabajo_isobarico();	
        if(prob===5) prob_trabajo_calor_isotermico();        
        if(prob===6) prob_trabajo_adiabatico();
