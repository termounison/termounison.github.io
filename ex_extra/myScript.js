...
function test(){
	...
	RespuestasNegativas = "no";
        ...
        if(prob2===8) prob_suma_dH();
		if(prob2===9) prob_ec_Trouton();
		...
		if(prob2===19) prob_ec_cinetica();
		if(prob2===20) prob_ec_cinetica_tabla();
		if(prob2===21) prob_ec_cinetica_vida_media();
		if(prob2===22) prob_ec_cinetica_tabla_2();
		if(prob2===23) prob_ec_Arrhenius();
...
function gameover(){
    ...
    resumen +="Examen ExtraOrdinario.<br>";
	...
	resumen +="Firma: "+firma[6]+","+firma[0]+","+firma[5]+","+firma[3]+","+firma[1]+","+firma[4]+","+firma[2]+","+firma[7]+"8314.<br>";
